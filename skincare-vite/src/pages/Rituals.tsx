    ...
    <div className={styles.root}>
      <section style={{ padding: '4rem 2rem', maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
        ...
        <p className={styles.subtext} style={{ margin: '1.5rem auto 0 auto' }}>
          Discover the unique rituals that make MTM a multi-sensory, holistic experience. Our rituals blend tradition, innovation, and natural therapies to nurture your mind, scalp, and spirit.
        </p>
      </section>
    </div>
  );
